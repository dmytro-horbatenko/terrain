          ...
          <div className="col gap-3">
            ...
            {mode === 'full' && (
              <p className="muted" style={{ margin: 0 }}>
                Exports your entire learning landscape — every active and planned topic, due
                reviews, and streak context.
              </p>
            )}
            ...
            {mode === 'domain' && (
              <div className="col gap-2">
                ...
                {topicsQ.isLoading ? (
                  ...
                  <p className="muted" style={{ margin: 0 }}>
                    No topics yet — add one on the Topics screen, or run a Full export and let
                    Claude propose your roadmap.
                  </p>
                ) : (
                  <select
                    id="export-domain"
            ...
            {mode === 'repeat' && (
              <p className="muted" style={{ margin: 0 }}>
                Today&apos;s interleaved review queue plus a conduct script — Claude quizzes you
                card by card and records your self-grades.
              </p>
            )}
